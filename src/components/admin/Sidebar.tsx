...
import ctgImg from "../../assets/img/logo-ct.png";
        ...
        <ul className="flex flex-col pl-0 mb-0">
          <li className="mt-0.5 w-full">
            <a
              className={
                pathname == "/admin"
                  ? "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap shadow-soft-xl rounded-lg px-4 font-semibold text-slate-700 transition-colors"
            ...
            <a
              className={
                pathname == "/admin/products"
                  ? "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap shadow-soft-xl bg-white px-4 transition-colors"
                  : "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center bg-white px-4 transition-colors"
              }
              href="/admin/products"
            >
